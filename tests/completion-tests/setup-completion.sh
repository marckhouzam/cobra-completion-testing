...
bash)
    ...
    ;;
fish)
    export allHelmGlobalFlags="--add-dir-header --alsologtostderr --debug --kube-apiserver --kube-context --kube-token --kubeconfig --log-backtrace-at --log-dir --log-file --log-file-max-size --logtostderr --namespace --registry-config --repository-cache --repository-config --skip-headers --skip-log-headers --stderrthreshold --v --vmodule -n -v"
    export allHelmLongFlags="--add-dir-header --alsologtostderr --debug --kube-apiserver --kube-context --kube-token --kubeconfig --log-backtrace-at --log-dir --log-file --log-file-max-size --logtostderr --namespace --registry-config --repository-cache --repository-config --skip-headers --skip-log-headers --stderrthreshold --v --vmodule"
#TODO the below is not right
    export allHelmGlobalFlags="--add-dir-header --alsologtostderr --debug --kube-apiserver --kube-context --kube-token --kubeconfig --log-backtrace-at --log-dir --log-file --log-file-max-size --namespace --registry-config --repository-cache --repository-config --skip-headers --skip-log-headers --stderrthreshold --v --vmodule -n -v"
    export allHelmLongFlags="--add-dir-header --alsologtostderr --debug --kube-apiserver --kube-context --kube-token --kubeconfig --log-backtrace-at --log-dir --log-file --log-file-max-size --namespace --registry-config --repository-cache --repository-config --skip-headers --skip-log-headers --stderrthreshold --v --vmodule"
    ;;
zsh)
