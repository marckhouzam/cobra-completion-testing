...
_completionTests_verifyCompletion "helm --v" "--v --vmodule"
_completionTests_verifyCompletion "helm --name" "--namespace"
_completionTests_verifyCompletion "helm --s" "--skip-headers --skip-log-headers --stderrthreshold"
_completionTests_verifyCompletion "helm show --s" "--skip-headers --skip-log-headers --stderrthreshold"
